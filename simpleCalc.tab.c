...
#line 16 "simpleCalc.y"
                       { printf("= %d\n", yyvsp[-1]); }
#line 1076 "simpleCalc.tab.c"
    break;

  case 5: /* exp: exp ADD factor  */
#line 21 "simpleCalc.y"
                     { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1082 "simpleCalc.tab.c"
    break;

  case 6: /* exp: exp SUB factor  */
#line 22 "simpleCalc.y"
                     { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1088 "simpleCalc.tab.c"
    break;

  case 8: /* factor: factor MUL term  */
#line 27 "simpleCalc.y"
                      { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1094 "simpleCalc.tab.c"
    break;
...
#line 1107 "simpleCalc.tab.c"
    break;

  case 10: /* term: NUMBER  */
#line 39 "simpleCalc.y"
           { yyval = yyvsp[0]; }
#line 1113 "simpleCalc.tab.c"
    break;

  case 11: /* term: ABS term  */
#line 40 "simpleCalc.y"
               { yyval = yyvsp[0] >= 0 ? yyvsp[0] : -yyvsp[0]; }
#line 1119 "simpleCalc.tab.c"
    break;


#line 1123 "simpleCalc.tab.c"
